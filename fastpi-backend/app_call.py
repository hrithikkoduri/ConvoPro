...
@app_call.get("/", response_class=JSONResponse)
async def index_page():
  return {"message": "Twilio Media Stream Server is running!"}


@app_call.api_route("/incoming-call", methods=["GET", "POST"])
...
@app_call.websocket("/media-stream")
...
if __name__ == "__main__":
  import uvicorn
  uvicorn.run(app_call, host="0.0.0.0", port=PORT)
